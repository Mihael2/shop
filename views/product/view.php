        ...
        <div class="shopping-page-wrapper">
          ...
          <div class="shipping-page-right">
            ...
            <div class="page-price-wrapping">
              ...
              class="shop-item-price-page">$ <?php echo $product['price']?> USD</div>
            ...
            <div>
              ...
              data-commerce-sku-id="5e856e69d83133dc75ed8681"
              data-loading-text="Adding to cart..."
              data-commerce-product-id="5e856e699643ac82dd7744dd"
              class="w-commerce-commerceaddtocartform">
                ...
                <div class="add-to-cart-page-wrapper">
                  ...
                  inputMode="numeric" id="quantity-8342fe54ad998bceba4bd86dd02b8e79"
                  name="commerce-add-to-cart-quantity-input"
                  min="1" class="w-commerce-commerceaddtocartquantityinput input cart-quantity"
                  value="1" />
              ...
              style="display:none" class="w-commerce-commerceaddtocarterror">
                ...
                data-w-add-to-cart-select-all-options-error="Please select an option in each set.">Product is not available
