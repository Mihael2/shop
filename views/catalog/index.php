  ...
  <div class="container">
    <div class="support-top-wrapper">
      <div class="support-top-left">
        ...
        <h2 class="support-top-heading">Categories:</h2></div>
      ...
      <?php foreach ($categories as $categoryItem): ?>
        ...
        <div class="support-square">
          ...
          <div class="support-square-text"> 
            ...
            <br></div><img src="https://assets.website-files.com/5e7ff3ec0c4ef4c974fa99e3/5e7ff57a5836db2a07bab0e3_Circle.svg"
          alt="Circle Decoration in Shop Products Block"
          class="support-square-image"></div>
      </div>
