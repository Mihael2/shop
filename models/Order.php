...
class Order{
    ...
    public static function getOrderList(){
        ...
        $db = Db::getConnection();
        $result = $db->query('SELECT id, user_name, user_phone, user_comment, user_id, date, products, status FROM product_order ORDER BY id ASC');
    ...
    public static function getOrderById($id){
        if($id){
            ...
            $db = DB::getConnection();
            $result = $db->query("SELECT user_name, user_phone, user_comment, user_id, date, products, status FROM product_order WHERE id = '$id'");
